  ...
  const options = [
    {
      ...
      description: "Premium LED Neon Flex. Energy-efficient, durable (50,000+ hours), and kid-safe (no heat/glass).",
      color: "blue"
    },
    {
      title: "Backboard Options",
      icon: <CubeTransparentIcon className="w-6 h-6" />,
      description: "High-quality acrylic in Clear, Black, White, or Colored. Cut to shape, rectangle, or invisible.",
      color: "purple"
    },
    {
      title: "Color Palette",
    ...
    {
      title: "Mounting Kits",
      icon: <SunIcon className="w-6 h-6" />, // Using Sun as placeholder for mounting/hanging logic? Or maybe Wrench? Let's stick to Sun for "Display"
      description: "Easy-install kits included: Wall mounting screws, hanging wires, or adhesive strips.",
      color: "cyan"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {options.map((option) => (
              <div key={option.title} className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className={`w-12 h-12 rounded-lg bg-${option.color}-50 flex items-center justify-center text-${option.color}-600 mb-4`}>
                  {option.icon}
                </div>
            ...
            <div className="h-full bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white relative overflow-hidden flex flex-col justify-between shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-300 mb-6 leading-relaxed">
                  Planning a large event, branding a franchise, or reselling? Unlock exclusive comprehensive B2B pricing tiers.
                </p>
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-gray-200 shadow-sm text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Every sign is unique. Share your vision and we'll provide a precise quote including production and shipping to your specific location.
          </p>
          <NextLink
            href="/contact"
